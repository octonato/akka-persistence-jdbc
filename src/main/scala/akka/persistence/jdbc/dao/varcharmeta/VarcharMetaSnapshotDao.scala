...
import akka.persistence.jdbc.dao.varcharmeta.SnapshotTables._
...
class VarcharMetaSnapshotDao(db: JdbcBackend#Database, val profile: JdbcProfile, system: ActorSystem) extends SnapshotDao {
